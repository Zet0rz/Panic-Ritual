...
if CLIENT then
	...
	local function recreatef1()
		...
		header:SetBackgroundColor(Color(60,0,0))
		header:Dock(TOP)
		local hh = header:Add("DLabel")
		hh:SetText("View hints that can appear in-game.")
		hh:SetFont("Ritual_ScrollAlive_Small")
		hh:SetWrap(true)
		hh:SetHeight(25)
		hh:DockMargin(10,0,0,0)
		hh:SetContentAlignment(5)
		hh:Dock(BOTTOM)
		local ht = header:Add("DLabel")
		ht:Dock(FILL)
		ht:SetText("HINTS")
		ht:SetFont("Ritual_HUDFont_Large")
		ht:SetTextColor(Color(255,255,255))
